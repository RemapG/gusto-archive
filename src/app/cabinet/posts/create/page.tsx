...
import { ArrowLeft, Star, Image as ImageIcon, Plus, Trash2, CheckCircle2 } from "lucide-react";
...
export default function CreatePostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setError(res.error || "Не удалось сохранить публикацию");
      }
    } catch (err: any) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#fcfcf9] flex items-center justify-center font-medium text-xs uppercase tracking-widest text-[#8a8883] animate-pulse">
        Проверка доступа...
      </div>
    );
  }
      ...
      <section className="max-w-[900px] mx-auto px-6 md:px-12 pt-12">
        <div className="mb-10">
          <span className="text-[10px] text-[#8a8883] uppercase tracking-[0.3em] font-bold block mb-3">
            БЛОГ • РЕСТОРАННЫЕ ОБЗОРЫ • СТАТЬИ
          </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-[#e2e0d8] shadow-sm space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Например: Мой вечер в Harvest — чистота вкуса и овощная магия"
            ...
            {/* Place Name & Rating (if it is a place review or applicable) */}
            ...
            <div className="pt-2 border-t border-[#f1f0e9]">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  placeholder="harvest-review (если пусто, сгенерируется автоматически)"
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#8a8883] mt-2">
                    JPG, PNG или WEBP. Будет отображаться в карточке и шапке статьи.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-[#f1f0e9]">
              <div className="flex justify-between items-center mb-3">
                <label className="block text-[10px] uppercase tracking-widest text-[#8a8883] font-semibold">
                  Дополнительные фото для галереи ({galleryFiles.length})
                </label>
              ...
              {galleryFiles.length === 0 ? (
                <p className="text-xs text-[#8a8883] font-light italic">
                  Дополнительные фотографии интерьера, блюд или процесса пока не добавлены.
                </p>
              ) : (
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-[#e2e0d8] shadow-sm space-y-4">
            ...
            <p className="text-[11px] text-[#8a8883] leading-relaxed">
              Пишите свободно, разделяя текст пустыми строками для создания абзацев. 
              Если хотите выделить цитату или блюдо — используйте кавычки.
            </p>

            <textarea
              value={content}
              onChange={(e) => setContent(e.target.value)}
              placeholder="Начните писать вашу статью или отзыв здесь..."
              rows={16}
              required
          ...
          <div className="flex items-center justify-between pt-4">
            ...
            >
              {submitting ? "Сохранение и публикация..." : "Опубликовать в блог"}
            </button>
          </div>
        </form>
      </section>
